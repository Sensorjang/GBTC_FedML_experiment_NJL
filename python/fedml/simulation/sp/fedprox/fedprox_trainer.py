...
class FedProxTrainer(object):
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            wb.save(self.args.excel_save_path + self.args.model + "_[" + self.args.dataset +"]_fedprox_training_results_NIID"+ str(self.args.experiment_niid_level) +".xlsx")
...
def plot_accuracy_and_loss(self, round_idx):
    ...
    plt.clf()
    plt.suptitle("FedProx" + "_[" + self.args.dataset +"]_NIID"+ str(self.args.experiment_niid_level))
