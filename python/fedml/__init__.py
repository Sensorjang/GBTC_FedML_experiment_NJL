...
def update_client_specific_args(args):
    """
        ...
        Example: In fedml_config_cifar100.yaml, we have the following configuration
    ...
    if (
        ...
        logging.info("data_silo_config is defined in fedml_config_cifar100.yaml")
        ...
        logging.info("data_silo_config is not defined in fedml_config_cifar100.yaml")
